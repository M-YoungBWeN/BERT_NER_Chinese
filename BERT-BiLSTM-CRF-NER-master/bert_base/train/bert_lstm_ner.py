...
def convert_single_example(ex_index, example, label_list, max_seq_length, tokenizer, output_dir, mode):
    ...
    :return:
    """
    # {'B-LOC': 1, 'B-ORG': 4, 'B-PER': 3, 'I-LOC': 7, 'I-ORG': 2, 'I-PER': 8, 'O': 6, 'X': 10, '[CLS]': 9, '[SEP]': 5}
    label_map = {}
    ...
    # [101, 3862, 7157, 3683, 6612, 1765, 4157, 1762, 1336, 7305, 680, 7032, 7305, 722, 7313, 4638, 3862, 1818, 511, 102]
